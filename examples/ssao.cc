...
int main() {
    ...
    auto camera = std::make_shared<qrk::Camera>(
        /* position */ glm::vec3( 2.0f, 1.0f, 5.0f ) );
    ...
    auto light =
        std::make_shared<qrk::PointLight>( glm::vec3( 0.0f, 5.0f, 0.0f ) );
    ...
    qrk::TextureMap brickwall(
        qrk::Texture::load( "examples/assets/brickwall.jpg" ),
    ...
    win.loop( [ & ]( float deltaTime ) {
        ...
        backpack.setModelTransform( glm::scale(
            glm::rotate(
                glm::translate( glm::mat4( 1.0f ), glm::vec3( 0, -2.2f, 0 ) ),
                glm::radians( -90.0f ), glm::vec3( 1.0f, 0.0f, 0.0f ) ),
            glm::vec3( 0.007f ) ) );
        backpack.draw( geometryPassShader );
        room.setModelTransform( glm::scale(
            glm::rotate(
                glm::translate( glm::mat4( 1.0f ), glm::vec3( 0, 5.0f, 0 ) ),
