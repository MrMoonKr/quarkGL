...
int main() {
    ...
    qrk::Shader mainShader(
        qrk::ShaderPath( "examples/shaders/shadow_map.vert" ),
    ...
    win.addKeyPressHandler(
        GLFW_KEY_1, [ & ]( int mods ) { drawShadowMap = !drawShadowMap; } );
