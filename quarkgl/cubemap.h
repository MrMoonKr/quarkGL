...
public:
    ...
    // Draws with the given shader to each face of the cubemap. This results in
    // 6 different draw calls. Shader should be prepared (i.e. necessary
    // textures should either be bound or be in the registry, uniforms should be
    // set, etc).
