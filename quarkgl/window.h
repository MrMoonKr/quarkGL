...
public:
    ...
    // TODO: Should this be called something different, and 'activate' be used
    // for setViewport?
    void activate();
    ...
    void enableStencilTest() {
        ...
        // depth test pass.
        glStencilOp( /*sfail=*/GL_KEEP, /*dpfail=*/GL_KEEP,
                     /*dppass=*/GL_REPLACE );
...
private:
    ...
    std::vector<std::tuple<int, std::function<void( int )>>>
        mouseButtonHandlers_;
