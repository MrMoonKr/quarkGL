...
void Window::loop( std::function<void( float )> callback ) {
    ...
    while ( !glfwWindowShouldClose( window_ ) ) {
        ...
        glClearColor( clearColor_.r, clearColor_.g, clearColor_.b,
                      clearColor_.a );
